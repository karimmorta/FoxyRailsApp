...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { country: @competition.country, name: @competition.name, short_name: @competition.short_name }
    end
  ...
  test "should update competition" do
    patch :update, id: @competition, competition: { country: @competition.country, name: @competition.name, short_name: @competition.short_name }
    assert_redirected_to competition_path(assigns(:competition))
  end
