...
class DivisionsControllerTest < ActionController::TestCase
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post :create, division: { country: @division.country, name: @division.name, short_name: @division.short_name }
    end
  ...
  test "should update division" do
    patch :update, id: @division, division: { country: @division.country, name: @division.name, short_name: @division.short_name }
    assert_redirected_to division_path(assigns(:division))
  end
